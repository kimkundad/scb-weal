    ...
    <div class="chakra-container-page">
        <div id="content" >
            ...
            <div class="box-height-10"></div>
                ...
                <div class="p-26 step1 hidden text-center" style="margin-top: 230px">
                    <div class="form-group">
                        <input type="text" name="number" style="width:310px" id="employeeCode" value="{{ old('number') }}" class="field__input" placeholder="ไม่ต้องใส่ S" required>
                            ...
                            <div id="result" style="margin-top: 10px; height: 80px; color: green;  text-align: center; font-size: 20px; ">
                    </div>
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                resultDiv2.innerHTML = `
                    <div> <p style="color: white; font-size: 22px">${data.data[4]} <br>${data.data[5]}</p> </div>
