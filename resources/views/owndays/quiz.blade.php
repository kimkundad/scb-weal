      ...
      <a href="{{ url('/') }}">
        ...
        <main>
            ...
            <div class="question-section">
                <div class="intro-container2" style="background-size: cover;">
                    <div class="intro-container">
                        <img src="{{ url('img/owndays/text@3x@3x.png') }}" style="width: 278px; margin-top:8px">


                        <img src="{{ url('img/owndays/ภาพ ‘ตัวตนของฉัน’ ที่คุณรั@3x.png') }}" style="width: 400px; padding: 0 40px; margin-top:8px; margin-bottom: 90px;">



        <!-- ปุ่มซ้อนอยู่บนรูป -->
                        <a href="{{ url('/quiz') }}" class="btn-image-link" >
                        <img src="{{ url('img/owndays/start.png') }}"
