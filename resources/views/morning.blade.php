...
<script>
    ...
    document.getElementById('searchBtn').addEventListener('click', function () {
        ...
        const time = 1; // เปลี่ยนเป็น 2 เพื่อเช็คคอลัมน์ที่ 10
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                if (data.data[8] && data.data[8] !== '') { // ตรวจสอบว่าคอลัมน์ 9 (index 8) มีข้อมูล
...
document.getElementById('registerBtn').addEventListener('click', function () {
            ...
            const checkinType = 1; // เปลี่ยนเป็น 1 หรือ 2 ตามกรณี
            const container = document.querySelector(".chakra-container-page");
            const step2 = document.querySelector(".step2");
