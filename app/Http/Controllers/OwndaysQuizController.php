    ...
    public function myResult($id){
         ...
         $products = [
            ...
            'B' => [
                ...
                'title' => 'เติมมุมบองความมั่นไอให้ตัวคุณ <span class="br-mobile"><br></span>ด้วยพลังเริ่มต้นใหม่แห่งสีเขียว',
            ...
            'E' => [
                ...
                'title' => 'เติมมุมมมองความมั่นใจให้ตัวคุณ <span class="br-mobile"><br></span>ด้วยความรื่นรมย์เบาสบายเเบบสีน้ำเงิน',
            ...
            'F' => [
                ...
                'color_footer' => '#574319',
                'bg' => 'linear-gradient(180deg, rgba(253, 231, 226, 1) 0%, rgba(249, 224, 194, 1) 51%, rgba(194, 207, 212, 1) 100%)',
                'title' => 'เติมมุมมองความมั่นใจให้ตัวคุณ <span class="br-mobile"><br></span>ด้วยพลังธรรมชาติที่มั่นคงของสีน้ำตาตาล',
    ...
    public function showResult()
    {
        ...
        $products = [
            ...
            'B' => [
                ...
                'color_footer' => '#574319',
                'bg' => 'linear-gradient(180deg, rgba(253, 231, 226, 1) 0%, rgba(245, 212, 168, 1) 51%, rgba(155, 183, 154, 1) 100%)',
                'title' => 'เติมมุมบองความมั่นไอให้ตัวคุณ <span class="br-mobile"><br></span>ด้วยพลังเริ่มต้นใหม่ใหม่เขียว',
                'subtitle' => 'สีเขียว แทนพลังธาตุไม้ที่พร้อมก่อเกิดงอกงามทุกเวลา',
                'desc' => 'ความมั่นใจในตัวคุณ เกิดจากความกล้าที่จะเริ่มต้นในสิ่งที่คุณเชื่อ แม้จะเป็นสิ่งใหม่ที่ไม่เคยมีมาก่อน การเปิดใจเรียนรู้ทุกประสบการณ์ คือกุญแจสำคัญของคุณ',
                'footer' => 'ลองเติมมุมมองนี้ด้วย<br>แว่นตาปางแห่งการริเริ่มสร้างสรรค์ ...',
                'path' => '22',
